namespace Utilities_Shared;

public static class ConsoleExtensions //no tenía Static, pero se lo vamos a poner para poderla usar sin necesidad de instanciar en cada uso
{
    public static int GetInt(string message)
    {
        ...
        // Para usarlo, i.e, var number = consoleExtension.GetInt ("Ingrese número entero: ");
        // Al usarla, como está en una carpeta diferente, le doy Ctrl+. y agrego referencia al Proyecto llamado Shared
    }
